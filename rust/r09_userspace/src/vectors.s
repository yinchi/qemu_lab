...
Named `kernel_entry` because it's EL1's (the kernel's) own entry trampoline -- used identically
regardless of whether the exception came from EL1 itself (irq_el1h) or from an EL0 user program
(sync_el0_64, irq_el0_64).
*/
.macro kernel_entry
	sub	sp, sp, #272
	stp	x0, x1, [sp, #16 * 0]
