...
//! property (DMA and CPU caches are always consistent), and this stage never
//! enables the memory management unit (MMU), so physical and
//! virtual addresses are always identical here. There is also no IOMMU;
