...
def run(ctx):
    ...
    width, _height, _rows = s.screendump()
    ...
    band = text_bands(s.screendump())[-2][1]
    ...
    lines = [band for _row, band in text_bands(s.screendump())[-8:-1]]
    ...
    after_bs = text_bands(s.screendump())[-2][1]
    s.run("echo X")
    plain_x = text_bands(s.screendump())[-2][1]
