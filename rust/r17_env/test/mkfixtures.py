...
def main():
    ...
    # Five 30000-byte variables: 150000 bytes of environment, past the 128 KiB `ARG_MAX` that arguments and environment
    # share, so nothing can be launched until they are unset (`cases/env.py`).
