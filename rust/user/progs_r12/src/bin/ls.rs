//! `ls [-F] [dir]` -- see `docs/progs.md`. Stage 12's tier replaces the base `ls` (same options and output) in one
//! respect: with no operand it lists the working directory, not the root -- the base tier's programs
//! predate the working directory, and r09-r11 still use them.
...
fn run(args: userlib::Args) -> ExitCode {
    ...
    // Use the specified directory or default to the working directory if none was provided.
